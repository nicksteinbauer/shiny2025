...
function Logo() {
  return (
    <div className="shinyLogo">
       
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 237.53 60.53">
        <g>
            <path className="shinyBlue" d="M0,18.65l7.99-0.5c0.17,1.3,0.52,2.29,1.06,2.97c0.87,1.1,2.1,1.65,3.71,1.65c1.2,0,2.12-0.28,2.77-0.84
            ...
            <path className="shinyBlue" d="M28.92,0.46h8.4v9.51h9.18V0.46h8.44v27.18H46.5V16.65h-9.18v10.99h-8.4V0.46z"/>
            <path className="shinyBlue" d="M60.85,0.46h8.42v27.18h-8.42V0.46z"/>
            <path className="shinyBlue" d="M75.35,0.46h7.84L93.43,15.5V0.46h7.92v27.18h-7.92L83.25,12.72v14.92h-7.9V0.46z"/>
            <path className="shinyBlue" d="M104.18,0.46h9.33l5.48,9.17l5.49-9.17h9.28l-10.57,15.8v11.38h-8.42V16.26L104.18,0.46z"/>
        </g>
        <g>
            <path className="shinyBlue" d="M28.67,32.88h7.98l2.87,15.22l4.2-15.22h7.95l4.21,15.2l2.88-15.2h7.94L60.7,60.07h-8.24L47.7,42.95
                l-4.75,17.11h-8.24L28.67,32.88z"/>
            <path className="shinyBlue" d="M69.77,32.88h8.42v27.18h-8.42V32.88z"/>
            <path className="shinyBlue" d="M84.27,32.88h7.84l10.23,15.04V32.88h7.92v27.18h-7.92L92.17,45.14v14.92h-7.9V32.88z"/>
            <path className="shinyBlue" d="M115.96,32.88h12.48c2.46,0,4.45,0.33,5.96,1c1.51,0.67,2.77,1.63,3.75,2.87c0.99,1.25,1.71,2.7,2.15,4.36
            ...
            <path className="shinyBlue" d="M144.32,46.49c0-4.44,1.24-7.89,3.71-10.37c2.47-2.47,5.91-3.71,10.33-3.71c4.52,0,8.01,1.21,10.46,3.64
            ...
            <path className="shinyBlue" d="M173.56,32.88h7.98l2.87,15.22l4.2-15.22h7.95l4.21,15.2l2.88-15.2h7.94l-5.99,27.18h-8.24l-4.77-17.11
                l-4.75,17.11h-8.24L173.56,32.88z"/>
            <path className="shinyBlue" d="M212.87,51.07l7.99-0.5c0.17,1.3,0.53,2.29,1.06,2.97c0.87,1.1,2.1,1.65,3.71,1.65c1.2,0,2.12-0.28,2.77-0.84
